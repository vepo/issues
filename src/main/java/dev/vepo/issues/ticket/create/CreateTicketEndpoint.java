...
public class CreateTicketEndpoint {
    ...
    @Inject
    public CreateTicketEndpoint(TicketService ticketService) {
    ...
    public TicketResponse create(@Valid CreateTicketRequest request, @Context SecurityContext securityContext) {
        return ticketService.create(request, securityContext.getUserPrincipal().getName());
    }
}
