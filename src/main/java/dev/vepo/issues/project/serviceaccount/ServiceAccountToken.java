...
@Entity
@Table(name = "tb_service_account_tokens")
public class ServiceAccountToken {
    ...
    public ServiceAccountToken(ServiceAccount serviceAccount, String name, String tokenHash, String tokenPrefix) {
    ...
    public boolean isActive() {
        return !isRevoked() && serviceAccount.isActive();
    }
}
