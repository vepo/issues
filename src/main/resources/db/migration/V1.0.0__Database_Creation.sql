...
CREATE TABLE tb_ticket_attachments (
    ...
    CONSTRAINT tb_ticket_attachments_ticket_FK FOREIGN KEY (ticket_id) REFERENCES tb_tickets,
    CONSTRAINT tb_ticket_attachments_user_FK FOREIGN KEY (uploaded_by) REFERENCES tb_users
);
...
CREATE TABLE tb_ticket_import_chunks (
    ...
    CONSTRAINT tb_ticket_import_chunks_import_FK FOREIGN KEY (import_id) REFERENCES tb_ticket_imports ON DELETE CASCADE
);

CREATE INDEX idx_ticket_import_chunks_import ON tb_ticket_import_chunks(import_id);
