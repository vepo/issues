...
@QuarkusTest
class UnreadNotificationCountEndpointTest {

    @Test
    void shouldRejectUnauthenticatedUnreadCount() {
    ...
    @Test
    void shouldReturnZeroUnreadWhenUserHasNoNotifications() {
    ...
    @Test
    void shouldReturnUnreadCountExcludingAlreadyReadNotifications() {
        var recipient = Given.randomUser();
        var auth = authenticate(recipient);
                      ...
                      .body("""
                            {
                                ...
                                "description": "Seed ticket for unread count tests.",
                                "projectId": %d,
                                "categoryId": %d
                            }
