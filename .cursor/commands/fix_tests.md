...
Follow [issues-testing.mdc](../rules/issues-testing.mdc) and [issues-test-failure-diagnosis.mdc](../rules/issues-test-failure-diagnosis.mdc).
...
**After fix is green:** write one report under `reports/` per [issues-test-failure-diagnosis.mdc](../rules/issues-test-failure-diagnosis.mdc).
