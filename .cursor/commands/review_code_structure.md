...
description: Audit class responsibilities, package boundaries, duplication, and rule compliance across Issues.
---
...
Read [issues-layered-architecture.mdc](../rules/issues-layered-architecture.mdc).
...
Read [issues-http-contract.mdc](../rules/issues-http-contract.mdc).
...
Read [issues-bounded-contexts.mdc](../rules/issues-bounded-contexts.mdc).
